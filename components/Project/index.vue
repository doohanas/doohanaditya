<template>
  <section class="grid min-h-[500px] grid-cols-1 gap-5 md:gap-16">
    <h1
...
import { PROJECT_LIST } from "@/utils/index"
defineComponent({
  name: "Project",
})
const projects = reactive({ projectList: [...PROJECT_LIST] })
</script>
